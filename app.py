...
from flask import Flask, request, session, render_template, redirect, url_for, json, jsonify
import psycopg2
...
DatabaseOperations = DatabaseOperations(get_db_connection()) #!!!important 
